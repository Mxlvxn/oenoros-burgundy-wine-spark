...
import { Lock, LogOut, Edit, Trash2, Plus, UserCircle } from 'lucide-react';
...
const AdminBlog = () => {
  ...
  const handleLogin = (e: React.FormEvent) => {
    ...
    if (user) {
      ...
      sessionStorage.setItem('oenoros_admin_username', user.username);
    } else {
  ...
  const handleLogout = () => {
    ...
    sessionStorage.removeItem('oenoros_admin_username');
  };
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-3">
              ...
              <button
                ...
                className="flex items-center gap-2 px-4 py-2.5 bg-cream hover:bg-cream-dark text-foreground rounded-full font-body text-sm transition-colors"
                title="Mon profil"
              >
