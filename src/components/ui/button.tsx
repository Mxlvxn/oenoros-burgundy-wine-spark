  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 font-body tracking-wide",
  {
    variants: {
      variant: {
        ...
        // Custom Oenoros variants
        hero: "bg-transparent border-2 border-gold text-gold hover:bg-gold hover:text-wine-dark uppercase tracking-[0.2em] font-medium",
        gold: "bg-gold text-wine-dark hover:bg-gold-light uppercase tracking-widest font-medium shadow-gold",
        wine: "bg-wine text-cream hover:bg-wine-light uppercase tracking-widest font-medium",
        elegant: "bg-transparent border border-gold/50 text-gold hover:border-gold hover:bg-gold/10 uppercase tracking-[0.15em] text-xs",
      },
      size: {
